...
//  3. No JWT provided alongsid Bearer yourTokenHere
//  
...
module.exports = (req, next) => {
    ...
    if (authType[0] === 'Basic') {
       ...
       if (authArray.length > 2) reqMessage(req, "Please provide a username and password for authentication." , next);
       authObject = {
        ...
        if (authObject[1] === 'undefined') reqMessage(req, "Please provide a jwt token with the format: 'Bearer yourTokenHere'" , next);
